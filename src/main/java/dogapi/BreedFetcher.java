...
public interface BreedFetcher {
    ...
    /**
     * Faetch the list of sub breeds for the given breed.
    ...
    class BreedNotFoundException extends Exception {
        ...
        public BreedNotFoundException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
